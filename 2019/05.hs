module Day05 where
    ...
    applyInstruction (Add p1 p2 p3) (m, i, o) = Just (run3 (+) m p1 p2 p3, i, o)
    applyInstruction (Mult p1 p2 p3) (m, i, o) = Just (run3 (*) m p1 p2 p3, i, o)
    ...
    applyInstruction a st = error $ show a
    ...
    run3 :: (Int -> Int -> Int) -> Memory -> Par -> Par -> Par -> Memory
    run3 f m@(pos, z) p1 p2 (Pos i3) = (pos', z')
        where 
            pos' = pos + 4
